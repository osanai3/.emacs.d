...
EMACS_PAGER="emacs --batch -l ~/.emacs.d/elpa/pipe-to-emacsclient-20211224.21131/pipe-to-emacsclient.el --eval='(pipe-to-emacsclient-batch)'"

alias e='emacsclient -n'
alias ep="PIPE_TO_EMACSCLIENT_BUFFER_NAME=*pager* $EMACS_PAGER"
