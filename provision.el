...
(mapc
 ...
 '(haskell-mode markdown-mode php-mode sequential-command smart-tab recentf-ext js2-mode coffee-mode google-translate key-combo restart-emacs exec-path-from-shell purescript-mode csharp-mode yaml-mode)
 )
